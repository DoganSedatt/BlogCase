...
public class AuthController : BaseController
{
    ...
    public async Task<IActionResult> Login([FromBody] UserForLoginDto userForLoginDto)
    {
        ...
        var getByMailQuery = new GetByEmailMemberQuery { Email = userForLoginDto.Email };
        var memberInfo = await Mediator.Send(getByMailQuery);

            
        return Ok(new { LoggedResponse = result.ToHttpResponse(), MemberInfo = memberInfo });
    }

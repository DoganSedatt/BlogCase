...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<OperationClaim> getFeatureOperationClaims(int initialId)
    {
        ...
        #region BlogPosts CRUD
        featureOperationClaims.AddRange(
            [
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Admin },
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Read },
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Write },
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Create },
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Update },
                new() { Id = ++lastId, Name = BlogPostsOperationClaims.Delete },
            ]
        );
        #endregion
